...
df = hours.set_index('Provider Waiting Room Status Provider ID').join(providers.set_index('Provider ID'), how='right')
...
# df_final.to_excel('Outputs/AmWell Log Extracts/AmWell Provider Hours Exec Update_2023_07_03.xlsx')
# output to root_billing_folder and output_file
output_file = 'output.xlsx'
root_billing_folder = '/Users/aman/dev-repositories/amwell-automation'
